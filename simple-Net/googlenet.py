...
f=open("test11_india_pines.txt","w")
...
tf.add_to_collection(tf.GraphDef.WEIGHTS,W_conv1)
...
tf.add_to_collection(tf.GraphDef.WEIGHTS,W_conv2)
...
tf.add_to_collection(tf.GraphDef.WEIGHTS,W_conv3)
...
tf.add_to_collection(tf.GraphDef.WEIGHTS,W_conv4)
...
tf.add_to_collection(tf.GraphDef.WEIGHTS,W_conv5)
...
tf.add_to_collection(tf.GraphDef.WEIGHTS,W_conv6)
...
tf.add_to_collection(tf.GraphDef.WEIGHTS,W_conv7)
...
tf.add_to_collection(tf.GraphDef.WEIGHTS,W_conv8)
...
tf.add_to_collection(tf.GraphDef.WEIGHTS,W_conv9)
...
h_flat=tf.reshape(output4,[-1,size*size*64])
